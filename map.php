...
$cityname = isset($_GET['cityname']) ? trim($_GET['cityname']) : 'beijing';
$documentdomain = isset($_GET['documentdomain']) ? trim($_GET['documentdomain']) : 0;
$title = isset($_GET['title']) ? checkhtml($_GET['title']) : 'The Location You Marked';
