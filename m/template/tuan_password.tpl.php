...
<h3 class="headbar">
    ...
    <p class="p-r">x<?=$ordernum ?></p>
</h3>
<form id="form_tuan" action="?mod=tuan&id=<?=$infoid?>&good=<?=$goodsid?>" enctype="multipart/form-data" method="post" name="form1" onSubmit="return check_sub();">
<div class="mb-list-fix mb-list-wrapper mb-line-tb m-b-10">
    <div class="mb-list-line mb-line-b">
        ...
        <div class="p-r">
            ...
            <input style="width: 200px;" name="ordernum" type="hidden" value="<?=$ordernum ?>">
