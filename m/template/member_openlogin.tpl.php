...
<head>
	...
	<title>QQ登录(中国元素) - <?=$mymps_global[SiteName]?></title>
...
<div class="body_div">
	...
	<div class="c_header">
  	...
  	<div class="dl_nav"><span><a href="index.php">Homepage</a><font class="body_bg"></font><a href="javascript:;">QQ登录(中国元素)</a></span></div> 

	<div class="m311 log_reg_box">
    <div id="logRegTabCon">
		<div class="log_reg_item mt10"><img src="<?=$figureurl_qq_1?>" align="center" height="20" width="20"/> &nbsp;<?=$nickname?>&nbsp;，还差一步，您就可以使用QQ账号登录了。(中国元素)
