	...
	<div class="detail">	
		...
		<ul class="attr_info" style="margin-top:0;">
			...
			<li>
				...
				<span class="attrVal"  style="<?php if($v[title] == 'Rent'|| $v[title] ==  'Price'|| $v[title] ==  'Real Estate Prices'|| $v[title] ==  'Contact Phone Number') echo 'color:#ff7800;font-weight:bold;font-size:20px;'?>"><?php if($v[value] == '0Ԫ/�£��й�Ԫ�أ�' || $v[value] == 'Discuss Face to Face Ԫ/�£��й�Ԫ�أ�'|| $v[value] == '0��Ԫ���й�Ԫ�أ�'|| $v[value] == '0��Ԫ/�꣨�й�Ԫ�أ�') {?>Discuss Face to Face<?php }else{ ?><?=$v[value]?><?php }?></span>
			</li>
			<?php }?>
		</ul>
		<?php }?> 
		...
		<ul class="attr_info bottom gray">
			<span class="attrVal mfico">
				<?php if(!empty($row['qq'])){?>
				<!--<li>
					<span class="attrName">��ϵ Q Q���й�Ԫ�أ���</span>
