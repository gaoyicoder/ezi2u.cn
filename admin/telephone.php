...
if(!submit_check(CURSCRIPT.'_submit')){
	...
	chk_admin_purview("purview_Telephone");
	
	$here = 'Convenience Hotline Settings';
	require_once dirname(__FILE__)."/include/ifview.inc.php";
	require_once dirname(__FILE__)."/include/color.inc.php";
	if($part == 'edit' && empty($id)) write_msg('You have not yet designated the ID of the item to be edited!');
	...
	write_msg('Convenience Hotline Settings have successfully been updated!',$forward_url ? $forward_url : 'telephone.php?cityi='.$cityid,'write_record');
