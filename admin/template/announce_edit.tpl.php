...
<td colspan="2"><b>Edit Site Announcement</b></td>
...
<tr bgcolor="#f5fbff" >
  ...
  <td width="12%" align="right">Announcement Title: </td>
  ...
  <option value="<?=$k?>" <?php if($k == $edit[titlecolor]) echo 'selected';?> style="background-color:<?=$k?>;"></option>
...
<tr bgcolor="#f5fbff" >
  ...
  <td><input id="datepicker1" readonly="readonly" name="begintime" class="text" type="text" value="<?=GetTime($edit[begintime])?>"/> If there is no need to specify the starting date of the announcement, please leave it blank.</td>
...
<tr bgcolor="#f5fbff" >
  ...
  <td><input id="datepicker2" readonly="readonly" name="endtime" class="text" type="text" value="<?=GetTime($edit[endtime])?>"/> If there is no need to specify the ending date of the announcement, please leave it blank.</td>
...
<tr bgcolor="#f5fbff" >
  ...
  <td>
    ...
    <input name="redirecturl" class="text" type="text" value="<?=$edit[redirecturl]?>" size="50"> If this part is filled, then you will not need to fill in the following parts
