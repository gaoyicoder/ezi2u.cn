 ...
 <tr>
     ...
     For sub-sites with individual second-level domain name for each, you will have to extensive-analyse the domain name to current server IP. Example: When the individual second-level domain name is *.mymps.com ,you will have to extensive-analyse it to current server IP.
      ...
      <FIELDSET><LEGEND>Apache.Introduction to Second-level Domain Name Pseudo-static Settings for all Sub-sites</LEGEND>
         ...
         1��For sub-sites with individual second-level domain name for each, you will have to extensive-analyse the domain name to current server IP.<br />

      2��Categories -> Sub-site Categories -> Built Sub-site -> Apply Second-level Domain Name to All Sub-sites

      <br />

3��<input class="mymps mini" value="Create Apache Pseudo-static Protocol" onclick="location.href='?action=makeapacherewrite'" type="button" alt="Click to create apache pseudo-static protocol files" title="Click to create apache pseudo-static protocol files"><br />

4��To change apache Setting files, add the following code to the last line:
