...
<div id="<?=MPS_SOFTNAME?>">
    <table border="0" cellspacing="0" cellpadding="0" class="vbm">
		...
		<tr bgcolor="white">
			...
			<label for="province"><input name="cfg_cityshowtype" value="province" type="radio" id="province" <?php if($mymps_global['cfg_cityshowtype'] == 'province') echo 'checked';?>>By Provinces (中国元素)</label>
			</td>
		</tr>
    	<tr class="firstr">
          <td colspan="2">First Visit to Homepage(<font style="text-decoration:underline"><?php echo $mymps_global['SiteUrl']; ?></font>)时打开</td>
        </tr>
		<tr bgcolor="white">
          <td style="line-height:25px;" colspan="2">
