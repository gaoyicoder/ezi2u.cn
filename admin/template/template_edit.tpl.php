...
<div class="ccc2">
    ...
    <ul>
        ...
        <img src="../images/warn.gif" align="absmiddle"> Notice on safety: Currently you are using online template editor </span>��<?=$cfg_if_tpledit?> . We recommend that you use it only when very necessary. You may change the file /dat/config.inc.php to disable it.
