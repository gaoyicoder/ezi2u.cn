...
<tr bgcolor="#f5fbff">
  ...
  <td> <input name="title" type="text" class="text" id="title" value="<?=$cat[title]?>" size="50"> <font color="red">*</font>(<font style="color:#FF6600">Example: NewsA_NewsB,  no more than 15 characters��)
