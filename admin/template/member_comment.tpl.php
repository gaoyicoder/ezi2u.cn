...
?>
    ...
    <tr style="background-color:white; display:none" id="pm_<?=$list[id]?>">
        ...
        <div style="margin:0 5px 10px 5px; padding:10px; background-color:#f2f2f2"><b>Liking£º</b>
            ...
            <b>Reply Content£º</b><?=$list[reply]?><hr style="height:1px; color:#dedede"/><b>Reply Time£º</b><?=GetTime($list[retime])?>
            </div>
            <?php }?>
        </div>
        </td>
