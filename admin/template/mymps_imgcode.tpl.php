...
<table border="0" cellspacing="0" cellpadding="0" class="vbm">
	...
	<tr bgcolor="#ffffff">
      <td align="left" width="200">
      	<?php foreach(array('english'=>'Image of English Letters','number'=>'Image of Digits','engber'=>'Image with English Letters and Digits','plus'=>'Image with a Summation Problem','minus'=>'Image with a Subtraction Problem','chinese'=>'中文图片验证码 (中国元素)') as $key => $val){?>
