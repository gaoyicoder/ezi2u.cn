...
<div class="ccc2">
    ...
    <ul>
        ...
        <img src="../images/warn.gif" align="absmiddle"> Note on Safety: we recommend that the current editing template </span>��<?=$cfg_if_tpledit?> be enabled unless very necessary. You may disable it by making changes to /data/config.inc.php.
