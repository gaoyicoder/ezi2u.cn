...
<td colspan="2">Configure Pay Port</td>
  ...
  <tr bgcolor="#f5fbff">
    ...
    <label for="r1"><input type="radio" name="buytype" value="1" id="r1" <?php if($paydetail[buytype] == 1) echo 'checked';?>>��ʱ�����տ���Ӧ֧����������������й�Ԫ�ط��룬�������ã�</label>

	<label for="r2"><input type="radio" name="buytype" value="2" id="r2" <?php if($paydetail[buytype] == 2) echo 'checked';?>>˫�����տ���Ӧ֧����������������й�Ԫ�ط��룬�������ã�</label>
  ...
  <tr bgcolor="#f5fbff">
    ...
    <input type="button" value="����ע��Ƹ�ͨ�̻���(�й�Ԫ��)" onclick="javascript:window.open('http://union.tenpay.com/mch/mch_index1.shtml');" class="gray">
  ...
  <tr bgcolor="#f5fbff">
    ...
    <td width="12%" height="25">֧�����ʺţ�(�й�Ԫ��)</td>
