...
<body <?php if($go == 'mymps_config') echo "onLoad=\"parent.framRight.location='mymps_config.php'\"";?>>
<div class='bodytitle'>
    ...
    <?php if($part != 'phpinfo'){?>
    <div class='iicon'>
    <a href='javascript:window.location.reload();'>Ref</a>
    <a href='javascript:history.back();'>Back</a>
    <a href='javascript:history.go(1);'>For</a>
	<a href='javascript:ascreen();' id="href">Full</a>
    </div>
    <?php }?>
</div>
<div class="clear"></div>
