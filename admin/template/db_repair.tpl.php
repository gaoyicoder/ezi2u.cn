...
<table border="0" cellspacing="0" cellpadding="0" class="vbm">
<tr class="firstr">
  <td width="70"><label for="chkall"><input name="chkall" id="chkall" class="checkbox" onclick="AllCheck('prefix', this.form)" checked="checked" type="checkbox" />Repair?</label></td><td>Data Sheet</td><td>Type</td><td>Number of Recordings</td><td>Data</td><td>Index</td><td>Fragments</td></tr>
<?php
...
<center><input type="submit" name="repair_submit" value="Submit" class="mymps large"/></center>
