...
<div class="goods">
	...
	<div class="hd"><span>Product Display</span></div>
	...
	<div class="info ileft">
		...
		<div class="bd intro">
			...
			<ul>
				...
				<? if(!$store[introduce]){?>There are currently no introduction to this institution<? }else{?><?=cutstr($store[introduce],460)?> <a target="_blank" href="<?=$uri[about]?>">[More]</a><? }?>
