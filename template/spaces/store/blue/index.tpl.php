...
<? if($goods){?>
<div class="goods">
	<div class="hd"><span>Vouchers</span></div>
	...
	<div class="bd">
		<ul>
			...
			<div class="shop_info" id="ISL_Cont_1">
				...
				<li><a href="<?=$mymps_global[SiteUrl]?>/<?=$list[uri]?>" title="<?=$list[goodsname]?>" target="_blank"><img src="<?=$mymps_global[SiteUrl]?><?=$list[pre_picture]?>"/></a><span><a href="<?=$list[uri]?>" title="<?=$list[goodsname]?>" target="_blank"><?=$list[goodsname]?></a></span><em>RM <font color="Grey"><del><?=$list[oldprice]?></del></font> <font color="Red"><?=$list[nowprice]?></font></em></li>
	...
	<div class="bd">
		<ul>
			...
			<div class="shop_info" id="ISL_Cont_1">
				...
				<li><a href="<?=$mymps_global[SiteUrl]?><?=$v[path]?>" title="<?=$v[title]?>" target="_blank"><img src="<?=$mymps_global[SiteUrl]?><?=$v[prepath]?>"/></a><span><a href="<?=$mymps_global[SiteUrl]?><?=$v[path]?>" title="<?=$v[title]?>" target="_blank"><?=$v[title]?></a></span></li>
				<? }?>
				</div> 
			<div class="next"><a href="javascript:void(0);" id="RightArr">Move Right</a></div>
		</ul>
...
<div class="showinfo">
	<div class="info ileft">
		<div class="hd"><span>Introduction</span></div>
		<div class="clearfix"></div>
		<div class="bd intro">
			<ul>
