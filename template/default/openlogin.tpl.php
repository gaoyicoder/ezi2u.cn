			...
			<div class="openlogin">
				...
				<div class="after-mpstopic">
					<ul>
						...
						<li class="firstli"> 您将使用QQ帐号(中国元素，建议斟酌) <img src="<?=$figureurl_qq_1?>" align="absbottom"/> <b><?=$nickname?></b> 注册本站，<a href="include/qqlogin/qq_login.php">更换QQ帐号(中国元素，建议斟酌)?</a></li>
						...
						<? }else{?>
						<li class="firstli">您将使用QQ帐号(中国元素，建议斟酌) <img src="<?=$figureurl_qq_1?>" align="absbottom"/> <b><?=$nickname?></b> 绑定本站用户名，<a href="include/qqlogin/qq_login.php">更换QQ帐号(中国元素，建议斟酌)?</a></li>
