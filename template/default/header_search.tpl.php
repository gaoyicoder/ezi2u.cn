      ...
      if (status == google.maps.GeocoderStatus.OK) 
      {
        ...
        for (var i=0; i<results[j].address_components.length; i++)
        {
		 ...
		 //To find which region it belongs to
		  ...
		  curState = "JOHOR";//region.long_name;//"JOHOR";
		  ...
		  { 
			...
			//  console.log(pos);
			  ...
			  if( pos >= 0)
		      {
				 // currentSubDomain = domainState[i];
				  ...
				  currentDomain = preDomain + i + 1;//currentSubDomain;
			...
			//	  console.log(currentDomain);
				  ...
				  currentDomain = ""; //the current location can not be recognized
		  }
...
<button onclick="getLocationAlways('<?=$city[cityname]?>')">Switch to Current Location</button>
