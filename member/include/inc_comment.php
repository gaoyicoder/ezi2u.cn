...
//$if_corp != 1 && write_msg('You have not yet enabled background for  seller management, please contact a customer staff to enable it.','olmsg');
...
if(submit_check('comment_submit')){
	...
	if(empty($id)){
		...
		if(!$comment['id']){
			...
			write_msg('Operation failed, for the comment does not exist!');
