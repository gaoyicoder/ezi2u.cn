                        ...
                        <div class="content-main-inner">
                            ...
                            <ul class="clearfix statistics-list">
								<div class="clearfix counttable">
									...
									<?php if($if_corp == 1){?>
									<div class="cli"><span class="label">Photos</span> <span class="value"><a href="index.php?m=album&type=corp"><?=$album_total?>Photos</a></span><input name="postinfo" value="Upload Photo&raquo;" type="button" class="postinfo" style="color:#12459c" onClick="location.href='index.php?m=album&ac=upload&type=corp'"></div>
									<div class="cli"><span class="label">Comments</span> <span class="value"><a href="index.php?m=comment&type=corp"><?=$comment_total?>Times</a></span></div>
									<div class="cli"><span class="label">Articles</span> <span class="value"><a href="index.php?m=document&type=corp"><?=$document_total?>Articles</a></span><input name="postinfo" value="Post Article&raquo;" type="button" class="postinfo" style="color:#12459c" onClick="location.href='index.php?m=document&ac=detail&type=corp'"></div>
									...
									<?php if($group_total){?><div class="cli"><span class="label">Group Purchases</span> <span class="value"><a href="index.php?m=group&type=corp"><?=$group_total?>Times </a></span> <input name="postinfo" value="Start Group Purchase&raquo;" type="button" class="postinfo" style="color:#12459c" onClick="location.href='index.php?m=group&ac=detail&type=corp'"></div><?php }?>
