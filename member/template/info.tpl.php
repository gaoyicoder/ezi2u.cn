    ...
    <div class="pbody">
	  ...
	  <tr class="xintit">
	    ...
	    <td colspan="3">
	    	...
	    	<span>View <?php echo $art['hit']?> ��</span>
          ...
          <tr>
			...
			<span class="examine"></span><b class="f14 red_f6">Place at the Top of the Homepage<?php if($art['upgrade_time_index'] != 0){ echo '��'.date("Y-m-d",$art['upgrade_time_index']);}?></b><br /><?php }?>

			

			<?php if($art['upgrade_type']){?>

			<span class="examine"></span><b class="f14 red_f6">Place at the Top of the Broad Headings<?php if($art['upgrade_time'] != 0){ echo '��'.date("Y-m-d",$art['upgrade_time']);}?></b><br /><?php }?>

			

			<?php if($art['upgrade_type_list']){?>

			<span class="examine"></span><b class="f14 red_f6">Place at the Top of the Sub-headings<?php if($art['upgrade_time_list'] != 0){ echo '��'.date("Y-m-d",$art['upgrade_time_list']);}?></b><br /><?php }?>
