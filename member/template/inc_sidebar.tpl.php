        ...
        <div class="sidebarmenu">
            <div class="sidebarmenu-inner">
                <div class="sidebarmenu-list">
                    ...
                    <ul class="index">
                    	<li <?php if($m != 'index'){?>onmouseover= "this.className= 'li_mouseover '; " onmouseout= "this.className= 'li_normal '; " <?php } if($m == 'index') echo 'class="current"';?>><a href="?type=<?php echo $type; ?>" class="house">Home</a></li>
                    </ul>
                        <?php 
				...
				<!-- <?php if($if_corp != 1 && $mymps_global[cfg_if_corp] == 1){?><div style="margin-top:6px"><a href="index.php?m=shop">Open Business</a></div>
				<?php }?> -->
            </div>  
        </div>
    </div>
