                                ...
                                <div class="pbody">
                                    ...
                                    <div class="clearfix pagetab-wrap">
                                        <ul class="pagetab">
                                            ...
                                            <li><a href="?m=pay&ac=use" <?php if($ac == 'use') echo 'class="current"'; ?>><span>Purchase Records</span></a></li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="datatablewrap">
                                        <table class="datatable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td>Number</td>
                                                        <td>Coins Deducted</td>
                                                        <td>Remark</td>
                                                        <td>Time of Deduct</td>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                <?php 
                                        ...
                                        <div class="clearfix datacontrol">
                                            <div class="dataaction">
                                                <span class="minbtn-wrap"><span class="btn"><input type="submit" value="Delete" class="button" name="pay_submit" onClick="if(!confirm('Are you sure you want to delete these purchase records? This cannot be reverted!'))return false;"/></span></span> 
                                            </div>
