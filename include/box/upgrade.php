...
if($ac == 'actionupgrade'){
	...
	if(!$row){
		echo "<center style='margin:20px; text-align:left; line-height:23px; color:#585858; font-size:12px'>Topping failed, for this post either does not exist or have not yet passed the revision!</center>";
		...
		echo "<center style='margin:20px; text-align:left; line-height:23px; color:#585858; font-size:12px'>Topping failed, for this post was not made by you!</center>";
		...
		echo "<center style='margin:20px; text-align:left; line-height:23px; color:#585858; font-size:12px'>Topping failed, for posts made by torists cannot be topped!</center>";
	}
}
