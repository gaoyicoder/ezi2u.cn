...
function get_member_cat($cat_arr='',$ifnone=true){
	...
	$option .= $ifnone == false ? "<select datatype=\"limit\" require=\"true\" msg=\"Please Select Category It Is From\" class=input name=catid>" : "<select datatype=\"limit\" require=\"true\" msg=\"Please Select Category It Is From\" class=input name=\"catid[]\">";

	$option .= $ifnone == false ? '<option value="">>Do Not Limit Category</option>' : '<option value="">Please Select Category It Is From</option>';
