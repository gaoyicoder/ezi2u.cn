			...
			<div class="extra_contact <? if($info[info_level] == 2){ ?>tuijian<? }?>">
				<div class="extra">
					<ul>
						...
						<li style="<? if(in_array($v[title],array('Price','Rent'))){?>color:red; font-weight:bold;<? }?>"><span><?=$v[title]?>：</span><? if(in_array($v[title],array('0元(中国元素,建议斟酌)','0元/月(中国元素,建议斟酌)','0万元(中国元素,建议斟酌)','0元/平米(中国元素,建议斟酌)'))){?>Discuss Face To Face<? }else{?><?=$v[value]?><? }?></li>
						<? }}?>
					</ul>
				</div>
				<div class="contact">
...
<!--XXXXXXXXXXXXXXXXXXXXXXX-->
	...
	<!----XXXXXXXXXXXXXXXXXXXXXXXX--->
		...
		<div class="bd_right">
			...
			<div class="boxer_hd cfix">Popular Sub-sites <?=$info[catname]?> Information</div>
			<div class="boxer_bd cfix noborder">
				<ul>
					...
					<? }}else{?>
					<li>Currently there are no posts from popular sub-sites!</li>
					<? }?>
				</ul>
			</div>
		</div>
